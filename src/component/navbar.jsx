...
<div className="fixed left-0 top-0 h-screen shadow-lg w-80 rounded-0xl bg-gradient-to-b from-[#000000] via-[#1c1c2c] to-[#283E51]
">
            ...
            <div>
              ...
              <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clock-icon lucide-clock">
               <path d="M12 6v6l4 2"/><circle cx="12" cy="12" r="10"/>
                ...
                <span className="mx-4 text-sm font-normal">Period</span>
              </a>
